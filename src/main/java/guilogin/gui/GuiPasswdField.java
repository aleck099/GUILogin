...
public class GuiPasswdField extends Gui
{
    ...
    public GuiPasswdField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
                ...
                default:
                    ...
                    if (ChatAllowedCharacters.isAllowedCharacter(typedChar))
                    {
                        if (this.isEnabled)
                        {
                            ...
                            char[] newpass = new char[this.text.length()];
                            System.arraycopy(this.passwd, 0, newpass, 0, this.passwd.length);
                            newpass[newpass.length - 1] = typedChar;
